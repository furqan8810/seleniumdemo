...
import com.demo.utilities.MonitoringMail;
...
public class CustomListeners implements ITestListener, ISuiteListener {
    ...
    private static ExtentReports extent = ExtentManager.createInstance(System.getProperty("user.dir")+"/src/test/reports/"+fileName);
